         ...
         <div class="row">
            ...
            <div class="row table-toolbar">
                <div class="col-lg-6">                    
                    ...
                    <a href="labels.php" class="btn btn-danger"><i class="fa fa-reply fa-fw"></i> Cancel</a>
                </div>                              
            </div>
            <!-- /.row -->
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                ...
                                $sql = "SELECT * FROM labels_db WHERE act = 1 AND id = ".$_GET['id'];
                                ...
                                ?>                             
                                    ...
                                    <h2>Label Info</h2>
                                        <div class="form-group">
                                                <label for="formid">Label ID</label>
                                        ...
                                        <div class="form-group">
                                            <label>Owner</label>
                                            <input class="form-control" placeholder="Label owner" name="formmusician" id="formmusician" value="<?php echo $row["musician"] ?>">
                                        </div>
                                        <div class="form-group">
    ...
    <script>
        $(function() {
            ...
            $('button[type="submit"]').click(function(e){
              ...
              var varmusician = $('#formmusician').val();
              ...
              $.ajax({
                type: 'POST',
                url: 'savelabeledit.php',
                data: {'varid': varid, 'varname': varname, 'varmusician': varmusician, 'vardesc': vardesc, 'varwebsite': varwebsite, 'varfacebook': varfacebook, 'vartwitter': vartwitter, 'varinstagram': varinstagram, 'varsoundcloud': varsoundcloud},      
                dataType: 'json',  
                success: function(data){
                //console.log(data);
                window.location.replace("labels.php#ok");
                 },
