       ...
       <!--Navigation-->
        ...
        <div class="row">
            ...
            <div class="row table-toolbar">
                                    ...
                                    <div class="col-lg-6">
                                          <div class="btn-group">
                                             <a href="addalbum.php"><button class="btn btn-success"><i class="fa fa-plus fa-fw"></i> Add Album</button></a>
                                          </div>
                                    </div>
                                    <div class="col-lg-6">
                                          <div class="btn-group pull-right">
                                             ...
                                             <ul class="dropdown-menu">
                                                ...
                                                <li><a href="exportfile.php?type=albumsxlsx" target="_blank">Download as spreadsheet</a></li>
                                                <li><a href="exportfile.php?type=albumscsv" target="_blank">Download as .CSV file</a></li>
                                                <li class="divider"></li>
                                                <li><a href="duplicatealbums.php">Find duplicate albums</a></li>
                                             </ul>
                                          </div>
                                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                        $sql = "SELECT * FROM full_db WHERE act = 1 ORDER BY id ASC";
                                ...
                                ?>
                                    <tr class="odd">
                                        ...
                                        <td><? echo $row["label"] ?></td>
                                        <td><? echo $row["formats"] ?></td>
                                        <td><? echo $row["releaseyear"] ?></td>
                                        <td><?php echo $row["id"] ?></td>
                                        <td class="center">
                                        <a href="editalbum.php?id=<? echo $row['id'] ?>"><i class="fa fa-pencil fa-fw"></i>Edit </a>
