                            ...
                            <form role="form">
                                <div class="row">
                                    ...
                                    <h2>Profile</h2>
                                        ...
                                        <div class="form-group">
                                            <label>jpg Image File (250px width)</label>
                                            <input class="form-control filestyle" type="file" id="formimg" name="formimg" data-input="false" data-buttonText="&nbsp;Choose Image">
                                        </div>
                                        <hr>
