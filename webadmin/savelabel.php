<?php require_once 'basics/config.php';
    ...
    $savesql = "INSERT INTO labels_db (name, description, musician, website, facebook, twitter, instagram, soundcloud, act) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	if (!$stmt->bind_param('ssssssssi', $varname, $vardesc, $varmusician, $varwebsite, $varfacebook, $vartwitter, $varinstagram, $varsoundcloud, $varact)) {
