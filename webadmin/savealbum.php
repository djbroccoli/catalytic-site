<?php require_once 'basics/config.php';
    ...
    $savesql = "INSERT INTO full_db (artistid, albumname, albumartist, personnel, label, releaseyear, formats, bandcamplink, quantity, wholesalecost, physical, albumcredits, coverlink, coverimgid, newadd, newrelease, dontslide, act) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $varmultipleartistpage = ($_POST['formartistpage']);
    //multiple artists
    //echo $_POST['formartistpage'];
    //$varmultipleartistpage = implode(', ', $_POST['formartistpage']);
    ...
    $vardontslide = $_POST['formdontslide'];
    $varact = "1";


	if (!$stmt->bind_param('sssssssssssssssssi', $varmultipleartistpage, $varalbumname, $varartist, $varpersonnel, $varlabel, $varreleaseyear, $varformats, $varbandcamplink, $varquantity, $varwholesale, $varphysical, $vardesc, $varcoverlink, $varcoverimgid, $varnewadd, $varnewrelease, $vardontslide, $varact)) {
