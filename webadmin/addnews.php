                                ...
                                <div class="row">
                                    ...
                                    <h2>New Post</h2>
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input class="form-control" placeholder="Enter title" name="formnametitle" id="formtitle">
                                        </div>
                                        <div class="form-group">
                                            <label>Subtitle</label>
                                            <input class="form-control" placeholder="Enter title" name="formnamesubtitle" id="formsubtitle">
                                        </div>
                                        <div class="form-group">
                                            <label>Text</label>
                                            <textarea class="form-control" rows="6" name="formtext" id="formtext"></textarea>
                                        </div>
                                        <hr>                                       
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
    ...
    <script>
        $(function() {
            ...
            $('button[type="submit"]').click(function(e){
              ...
              formData.append("formtitle", $('#formsubtitle').val());
