                        ...
                        <div class="panel-body">
                            <form role="form">
                                <div class="row">
                                    ...
                                    <h2>Artwork</h2>
                                        <img id="img-cover" src="http://catalyticsound.com/imgs/no-albumcover.png" class="img-responsive" style="max-width: 250px;margin-top: 30px;margin-bottom: 30px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="dontslide" value="x" id="formdontslide">DO NOT add to slide show
                                                </label>
