         ...
         <div class="row">
            ...
            <div class="row table-toolbar">
                <div class="col-lg-6">
                    ...
                    <a href="news.php" class="btn btn-danger"><i class="fa fa-reply fa-fw"></i> Cancel</a>
                </div>
            </div>
            <!-- /.row -->
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form">
                                ...
                                $sql = "SELECT * FROM news_db WHERE act = 1 AND id = ".$_GET['id'];
                                ...
                                ?>
                                    ...
                                    <h2>Edit Post</h2>
                                        <div class="form-group">
                                                ...
                                                <input class="" type="text" placeholder="Disabled input" name="formid" id="formid" value="<?php echo $row["id"] ?>" hidden>
                                            </div>
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input class="form-control" placeholder="Enter text" name="formtitle" id="formtitle" value="<?php echo $row["title"] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Subtitle</label>
                                            <input class="form-control" placeholder="Enter text" name="formsubtitle" id="formsubtitle" value="<?php echo $row["subtitle"] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Text</label>
                                            <textarea class="form-control" rows="4" name="formtext" id="formtext"><?php echo $row["message"] ?></textarea>
                                        </div>
                                        <div class="checkbox">
                                                <label>
                                                    <input <?php if ($row["frontpage"] == 1) { echo "checked"; } ?> type="checkbox" name="formfrontpage" value="1" id="formfrontpage">Show on home page?
                                                </label>
                                        </div>
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
        ...
        <script>
            $(function() {
                ...
                $('button[type="submit"]').click(function(e){
                  ...
                  formData.append("formsubtitle", $('#formsubtitle').val());
                  formData.append("formtext", $('#formtext').val());
                  ...
                  $.ajax({
                    ...
                    success: function(data){
                    //console.log(data);
                    window.location.replace("news.php#ok");
                     },
