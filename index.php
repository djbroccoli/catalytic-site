...
<script id="mcjs">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,"script","https://chimpstatic.com/mcjs-connected/js/users/57a33819db3bd2440cbfed0ee/71ebb870ca0597894262b997e.js");</script>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10 text-banner">
                    ...
                    <!--<p><a href="https://www.patreon.com/bePatron?u=13528147" data-patreon-widget-type="become-patron-button">Become a Patron!</a><script async src="https://c6.patreon.com/becomePatronButton.bundle.js"></script></p>-->
    ...
    <div class="container">
        ...
        <div class="row section-news">
            <div class="col-lg-12">
                            ...
                            <div class="col-sm-12">
                                <div class="news-bg">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <p class="first-text"><? echo $rownews["message"] ?></p>
                                        </div>  
                                    </div>
                                </div>
                            </div>                         
                ...
                <div class="row">
                    <?php
                        $sqlnews = "SELECT * FROM news_db WHERE act = 1 AND frontpage = 1 ORDER BY id DESC LIMIT 2 OFFSET 1";
                        $resultnews = $conn->query($sqlnews);
                        if ($resultnews->num_rows > 0) {
                        // output data of each row
                        while($rownews = $resultnews->fetch_assoc()) {
...
<div class="modal fade" id="modal-shipping" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
         <div class="">
            <div class="modal-header text-center" style="border:initial">
                <a class="close" href="#" data-dismiss="modal" style="color:#000;float:none;background:#fff;border-radius:50%;padding:5px 10px;opacity:0.7;">X</a>
              </div>
              <div class="modal-body">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <a href="https://festival.catalyticsound.com/" target="_blank">
                            <img src="imgs/CSFest2020.png" class="img-responsive">
                        </a>
                    </div>
                </div>
