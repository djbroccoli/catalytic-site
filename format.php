   ...
   <!-- Catalog Section -->
    <section id="catalog" class="catalog-section">
        <div class="">
            ...
            ?>
                <div class="col-sm-6 col-md-3 disco<?php foreach ($formatx as $key => $val) {echo " " .$val;} if ($row["newrelease"] > "") { echo " newrelease"; } elseif ($row["newadd"] > "") {echo " newaddition";} elseif ($row["aotw"] > "") {echo " aotw";}?>">
