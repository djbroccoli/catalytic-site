...
$admin_email = 'jdvillafane@gmail.com';

//EMAIL SETTINGS
//SEND TEST EMAILS THROUGH FORM TO https://www.mail-tester.com GENERATED ADDRESS FOR SPAM SCORE
$from_email = 'joel@mclovin.com.ar'; //Webmaster email
$from_name = 'Webmaster'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'relay-hosting.secureserver.net';
$smtp_user = 'joel@mclovin.com.ar';
$smtp_pw = 'Hol@mc2016';
$smtp_port = 25; //465 for ssl, 587 for tls, 25 for other
$smtp_security = 'false';//ssl, tls or ''
