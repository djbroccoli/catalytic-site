    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
         <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Label</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <form role="form">
                                <div class="row">                               
                                    ...
                                    <h2>Label Info</h2>
                                        ...
                                        <div class="form-group">
                                            <label>Owner</label>
                                            <input class="form-control" placeholder="Label owner" name="formmusician" id="formmusician">
                                        </div>
                                        <div class="form-group">
        ...
        $(function() {
            ...
            $('button[type="submit"]').click(function(e){
              ...
              $.ajax({
                type: 'POST',
                url: 'savelabel.php',
                data: {'varname': varname, 'varmusician': varmusician, 'vardesc': vardesc, 'varwebsite': varwebsite, 'varfacebook': varfacebook, 'vartwitter': vartwitter, 'varinstagram': varinstagram, 'varsoundcloud': varsoundcloud},      
                dataType: 'json',          
