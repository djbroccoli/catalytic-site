...
<header>
    ...
    //$start_from = ($page-1) * $limit;
            ...
            $stmt->bind_result($stmtid, $stmtartistid, $stmtalbumname, $stmtalbumartist, $stmtpersonnel, $stmtlabel, $stmtreleaseyear, $stmtformats, $stmtbandcamplink, $stmtbandcampembedid, $stmtquantity, $stmtwholesalecost, $stmtphysical, $stmtalbumcredits, $stmtcoverlink, $stmtcoverimgid, $stmtnewadd, $stmtnewrelease, $stmtact, $stmtimgpath);
   ...
   <!-- Catalog Section -->
    <section id="catalog" class="catalog-section">
        <div class="">
            ...
            ?>
                <div class="col-sm-6 col-md-3 disco<?php foreach ($formatx as $key => $val) {echo " " .$val;} if ($stmtnewrelease > "") { echo " newrelease"; } elseif ($stmtnewadd > "") {echo " newaddition";}?>">
