...
!function(t){"use strict";t("#herovideo").on("loadeddata",function(){t(".loading-cover").fadeOut("slow")}),t('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var e=t(this.hash);if((e=e.length?e:t("[name="+this.hash.slice(1)+"]")).length)return t("html, body").animate({scrollTop:e.offset().top-54},1e3,"easeInOutExpo"),!1}}),t(".link-item").on("click",function(e){e.preventDefault(),t(".hero .hero-authors").addClass("openhero"),t(".hero-authors .links-container").removeClass("col-12"),t(".hero-authors .links-container").addClass("col-2"),t(".content").removeClass("d-none"),t(".content").addClass("col-10"),t("#herovideo").prop("loop",!1)}),function(){for(var e=document.querySelectorAll(".youtubebox"),t=0;t<e.length;t++){var o="https://i.ytimg.com/vi/"+e[t].dataset.embed+"/hqdefault.jpg",n=new Image;n.src=o,n.addEventListener("load",void e[t].appendChild(n)),e[t].addEventListener("click",function(){var e=document.createElement("iframe");e.setAttribute("frameborder","0"),e.setAttribute("allowfullscreen",""),e.setAttribute("src","https://www.youtube.com/embed/"+this.dataset.embed+"?rel=0&showinfo=0&autoplay=1"),this.innerHTML="",this.appendChild(e)})}}()}(jQuery);